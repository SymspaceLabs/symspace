...
{
    public class TOARHumanBodyTracker : MonoBehaviour
    {
        [SerializeField]
        ...
        Dictionary<TrackableId, TOARBoneController> m_SkeletonTracker = new Dictionary<TrackableId, TOARBoneController>();
        ...
        {
            TOARBoneController boneController;
            ...
            foreach (var humanBody in eventArgs.added)
            {
                if (!m_SkeletonTracker.TryGetValue(humanBody.trackableId, out boneController))
                {
                    ...
                    boneController = newSkeletonGO.GetComponent<TOARBoneController>();
