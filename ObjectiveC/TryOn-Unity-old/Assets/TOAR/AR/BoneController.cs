...
namespace TOAR.AR
{
    public class BoneController : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("Max tracking bones")]
        [Range(0,91)]
        private int m_MaxBoneIndex = 1;
        [SerializeField]
        [Tooltip("The root bone of the skeleton.")]
        Transform m_SkeletonRoot;
        [SerializeField] [Tooltip("Manual bone transforms array")]
        ...
        public void ApplyBodyPose(ARHumanBody body)
        {
            ...
            var maxJoinsNum = m_MaxBoneIndex > k_NumSkeletonJoints ? k_NumSkeletonJoints : m_MaxBoneIndex;

            for (int i = 0; i < maxJoinsNum; ++i)
            {
