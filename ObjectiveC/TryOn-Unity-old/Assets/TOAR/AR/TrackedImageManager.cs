...
namespace TOAR.AR
{
    ...
    public class TrackedImageManager : MonoBehaviour
    {
        ...
        {
            var image = trackedImage.GetComponent<ImageMarkerController>();
            ...
            */
            ...
            Debug.Log("### trackingState:" + trackedImage.trackingState + " name:" + trackedImage.referenceImage.name);
            ...
            if (trackedImage.trackingState == TrackingState.None || trackedImage.trackingState == TrackingState.Limited)
            {
                ...
                // The image extents is only valid when the image is being tracke
                // Set the texture
            ...
            else
            {
                ...
                image.Show(trackedImage.referenceImage.name);
            }
        }
        ...
        void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
        {
            ...
            {
                Debug.Log("###Remove trackedImage" + trackedImage.referenceImage.name);
                var image = trackedImage.GetComponent<ImageMarkerController>();
                image.HideAll();
                Destroy(trackedImage);
            }
